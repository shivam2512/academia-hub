...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DoZn4RF4.mjs");
...
const manifest = {
  "2ffd6b62225054eb509d5ccb287595818e28137470cffce2c16d81d4c63114ce": {
    functionName: "createUser_createServerFn_handler",
    importer: () => import("./users-tE7Q6Z9w.mjs")
  },
  "685549eb02bf20ba8c36a1608a4462af7fc321f692b60c0797bf593d226ea35d": {
    functionName: "deleteUser_createServerFn_handler",
    importer: () => import("./users-tE7Q6Z9w.mjs")
  },
  "f17cab7f15ce4f0fb79feb40a24b1484baa6635c1277a1b68ff98868a5ef7e04": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BukZEc3n.mjs").then((n) => n.r),
